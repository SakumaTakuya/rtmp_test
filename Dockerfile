...
# RUN mkdir -p /usr/local/nginx/html/record/hls && mkdir -p /usr/local/nginx/html/live/hls
RUN mkdir -p /usr/local/nginx/html/record/hls && \
    mkdir -p /usr/local/nginx/html/live/hls && \
    chmod -R 777 /usr/local/nginx/html/record/hls /usr/local/nginx/html/live/hls
